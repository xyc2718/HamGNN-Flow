...
EDGE_CELL_SHIFT_KEY: Final[str] = "cell_shift"
...
ATOMIC_NUMBERS_KEY: Final[str] = "z"
# [n_atom, 1] long tensor
...
# [n_triplet, dim]
ANGLE_EMBEDDING_KEY: Final[str] = "angle_embedding"
TRIPLET_FEATURES_KEY: Final[str] = "triplet_features"
# (idx_i, idx_j, idx_k, idx_kj, idx_ji)
TRIPLET_INDEX_KEY: Final[str] = "triplet_index"
